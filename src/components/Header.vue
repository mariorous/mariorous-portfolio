...
const emit = defineEmits(['toggleDarkMode', 'toggleLanguage'])
...
<template>
    <header class="bg-transparent flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full relative h-20">
    <nav class="relative max-w-[85rem] w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2">
        ...
        <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="#">
            <svg class="dark:fill-white" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="34" height="34" viewBox="0 0 64 64">
                <path d="M6 13.236v33.009c0 1.084.585 2.083 1.529 2.615l11.49 6.463C20.353 56.073 22 55.11 22 53.58V18L8.894 11.447C7.565 10.782 6 11.749 6 13.236zM42.927 47.674l14.5-28.999-13.659-7.759c-.978-.506-2.181-.127-2.691.848l-8.664 16.541L42.927 47.674zM36.955 45.055L26 24.876 26 38.838zM58 26.472L46.087 50.299l8.933 5.025C56.353 56.073 58 55.11 58 53.58V26.472z"></path>
            </svg>
        </a>
        ...
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-blue-200 dark:hover:text-blue-500" href="#" aria-current="page">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-blue-200 dark:hover:text-blue-500" href="#projects">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-blue-200 dark:hover:text-blue-500" href="#aboutMe">
            ...
            <a class="group font-medium p-2 flex items-center text-sm text-gray-800 hover:text-gray-500 focus:outline-none dark:text-gray-200 dark:hover:text-neutral-500" href="#">
                <svg class="shrink-0 size-4 me-3 md:me-2 block md:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 12h.01"/><path d="M16 6V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/><path d="M22 13a18.15 18.15 0 0 1-20 0"/><rect width="20" height="14" x="2" y="6" rx="2"/></svg>
                {{ $t('wallpapers') }}
                <span class="hidden group-hover:block absolute transform -translate-x-2 -translate-y-6 text-white text-xs font-bold bg-blue-500 border-2 border-blue-600 px-2 py-0.5 rounded-lg">
                    {{  $t('comingSoon') }}
                </span>
            </a>

            <a class="group font-medium p-2 flex items-center text-sm text-gray-800 hover:text-gray-500 focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:hover:text-neutral-500" href="#">
                ...
                {{ $t('blog') }}
                <span class="hidden group-hover:block absolute transform -translate-x-8 -translate-y-6 text-white text-xs font-bold bg-blue-500 border-2 border-blue-600 px-2 py-0.5 rounded-lg">
                    {{  $t('comingSoon') }}
                </span>
            </a>
            ...
            <div class="flex items-center">
                <button @click="$emit('toggleDarkMode')"
                    ...
                    <svg v-if="!isDarkMode" class="fill-violet-700 block" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                    </svg>
                    <svg v-else class="fill-yellow-500 block" fill="currentColor" viewBox="0 0 20 20">
                        <path
            ...
            <div class="flex items-center">
                ...
                <button @click="toggleLanguage" class="h-10 w-10 rounded-lg flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg v-if="currentLanguage === 'es'" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="w-8 iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
                        ...
                        <path fill="#F4A2B2" d="M12 16h3v3h-3z"></path><path fill="#DD2E44" d="M9 16h3v3H9z"></path><ellipse fill="#EA596E" cx="12" cy="14.5" rx="3" ry="1.5"></ellipse><ellipse fill="#FFAC33" cx="12" cy="13.75" rx="3" ry=".75"></ellipse>
                        <path fill="#99AAB5" d="M7 16h1v7H7zm9 0h1v7h-1z"></path>
                        <path fill="#66757F" d="M6 22h3v1H6zm9 0h3v1h-3zm-8-7h1v1H7zm9 0h1v1h-1z"></path></g></svg>  
                    <svg v-else viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="w-8 iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
