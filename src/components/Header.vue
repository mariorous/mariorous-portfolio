...
<template>
    ...
    <nav class="relative max-w-[85rem] w-full md:flex md:items-center md:justify-between md:gap-3 mx-auto px-4 sm:px-6 lg:px-8 py-2">
        ...
        <div class="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-gray-200 dark:hover:text-blue-500" href="#" aria-current="page">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-gray-200 dark:hover:text-blue-500" href="#projects">
            ...
            <a class="font-medium p-2 flex items-center text-sm text-gray-800 hover:text-blue-500 focus:outline-none dark:text-gray-200 dark:hover:text-blue-500" href="#aboutMe">
